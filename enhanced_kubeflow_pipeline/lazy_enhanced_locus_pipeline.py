...
# Components 
models_keeper_op = kfp.components.load_component_from_file(os.path.join('./models_keeper/', 'component.yaml'))
...
def enhanced_locus_pipeline(minio_url, minio_access_key, minio_secret_key):

    # Push Datasets
    models_keeper = models_keeper_op()
    ...
    # Load from Datasets
    data_loading = data_loading_op(openpflow_trajectories_path = models_keeper.outputs['openpflow_trajectories_output'],
        nodes_npz_path = models_keeper.outputs['nodes_npz_output'], tokyo_osmpbf_path = models_keeper.outputs['tokyo_osmpbf_output'])
    ...
    tensorflow_training = tensorflow_training_op(prep_openpflow_trajectories_path = numpy_preprocessing.output,
        ...
        tree_pkl_path = models_keeper.outputs['tree_pkl_output'])
